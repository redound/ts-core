...
var Timer = (function (_super) {
    ...
    Timer.prototype.start = function () {
        ...
        this.events.trigger(exports.TimerEvents.START, {
    ...
    Timer.prototype.resume = function () {
        ...
        this.events.trigger(exports.TimerEvents.RESUME, {
            startDate: this._startDate,
    ...
    Timer.prototype.pause = function () {
        ...
        this.events.trigger(exports.TimerEvents.PAUSE, {
            startDate: this._startDate,
            tickCount: this._tickCount,
            elapsedTime: this.elapsedTime
        });
    ...
    Timer.prototype.stop = function () {
        ...
        this.reset();
        this.events.trigger(exports.TimerEvents.STOP, eventParams);
    };
    ...
    Timer.prototype._timerTick = function () {
        ...
        this.events.trigger(exports.TimerEvents.TICK, {
            startDate: this._startDate,
            tickCount: this._tickCount,
            elapsedTime: this.elapsedTime
        });
