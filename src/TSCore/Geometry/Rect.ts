module TSCore.Geometry {
    ...
    export class Rect extends TSCore.BaseObject {
         ...
         *
         * @returns {TSCore.Geometry.Rect}
         */
        public inset(top: number, right: number, bottom: number, left: number): TSCore.Geometry.Rect {
         ...
         * @returns {TSCore.Geometry.Rect}
         */
        public insetCenter(horizontal: number, vertical: number): TSCore.Geometry.Rect {
         ...
         * @returns {TSCore.Geometry.Rect}
         */
        public expand(horizontal: number, vertical: number): TSCore.Geometry.Rect {
         ...
         * @returns {TSCore.Geometry.Rect}
         */
        public reduce(horizontal: number, vertical: number): TSCore.Geometry.Rect {
            this.insetCenter(horizontal, vertical);
