...
describe("TSCore.Data.Set", () => {
    ...
    describe("add()", () => {
        ...
        it("should fire SetEvents.CHANGE", () => {
    ...
    describe("remove()", () => {
        ...
        it("should decrease the size of the instance", () => {
            ...
            // Prepare
            var animals = [animal1, animal2, animal3, animal4];
            var dataSet = new TSCore.Data.Set<IAnimal>(animals);
        ...
        it("should fire SetEvents.REMOVE", () => {
    ...
    describe("count()", () => {
        ...
        it("should alias magic getter for this._data.length", () => {
            ...
            var dataSet = new TSCore.Data.Set<IAnimal>();
    ...
    describe("constructor()", () => {
        ...
        it("should increase the size of the instance when passing data", () => {
            ...
            var dataSet = new TSCore.Data.Set<IAnimal>([animal1, animal2]);
    ...
    describe("clear()", () => {
        ...
        it("set should been empty when called", () => {
            ...
            var dataSet = new TSCore.Data.Set<IAnimal>([animal1, animal2, animal3, animal4]);
